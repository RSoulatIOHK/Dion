...
lean_obj_res dion_test_simple(uint32_t x, lean_obj_arg world) {
...
lean_obj_res dion_get_unix_time(lean_obj_arg world) {
    struct timeval tv;
...
lean_obj_res dion_get_unix_time_ms(lean_obj_arg world) {
    struct timeval tv;
    gettimeofday(&tv, NULL);
